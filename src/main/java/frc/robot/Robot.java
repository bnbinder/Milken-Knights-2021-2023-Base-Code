...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    try {
      arduino = new SerialPort(9600, "/dev/ttyACM0", SerialPort.Port.kUSB, 8, SerialPort.Parity.kNone,
  ...
  public void teleopPeriodic() {
     ...
     * if(keyIn.length() > 12)
     * {
     * //substring because idk why but arduino reads number but when put into a
     * string things get funky
