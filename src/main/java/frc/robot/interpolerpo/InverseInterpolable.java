 ...
 * object can calculate the interpolation parameter of the query key on the interval [0, 1].
 *
...
public interface InverseInterpolable<T> {
  ...
  /**
   * Given this point (lower), a query point (query), and an upper point (upper), estimate how far (on [0, 1]) between 'lower' and 'upper' the query point
   * lies.
   *
   * @param upper
   * @param query
